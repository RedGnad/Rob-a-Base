...
export const MESSAGES = {
  ...
  quests: Schemas.Map({
    ...
    joursPris: Schemas.Array(Schemas.Int)
  }),
  ...
  offlineEarnings: Schemas.Map({ gain: Schemas.Int64, seconds: Schemas.Int, capped: Schemas.Boolean }),
