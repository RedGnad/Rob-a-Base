...
# Two review switches live in theme.ts for the desktop review of the phone layout. Either one
# left on would ship a forced phone layout or a fake HUD state to every player: refuse the build.
